...
INSERT INTO autor (id, nome, sobrenome, nome_conhecido, sexo, data_nascimento, data_falecimento, pais_nascimento, estado_nascimento, cidade_nascimento, biografia, url_site_oficial, url_facebook, url_twitter, url_wikipedia) VALUES (9,'Joaquim ','Maria Machado de Assis','Machado de Assis','M','1839-06-21','1908-09-29','Brasil','Rio de Janeiro','Rio de Janeiro','Joaquim Maria Machado de Assis foi um escritor brasileiro, considerado por muitos críticos, estudiosos, escritores e leitores o maior nome da literatura brasileira.','','','','');
INSERT INTO autor (id, nome, sobrenome, nome_conhecido, sexo, data_nascimento, data_falecimento, pais_nascimento, estado_nascimento, cidade_nascimento, biografia, url_site_oficial, url_facebook, url_twitter, url_wikipedia) VALUES (10,'François-Marie','Arouet','Voltaire','M','1694-11-21','1778-05-30','França',NULL,'Châtenay',NULL,NULL,NULL,NULL,NULL);
INSERT INTO autor (id, nome, sobrenome, nome_conhecido, sexo, data_nascimento, data_falecimento, pais_nascimento, estado_nascimento, cidade_nascimento, biografia, url_site_oficial, url_facebook, url_twitter, url_wikipedia) VALUES (11,'Javier','Cercas Mena','Javier Cercas','M',NULL,NULL,'Espanha',NULL,'Cáceres',NULL,NULL,NULL,NULL,NULL);
INSERT INTO autor (id, nome, sobrenome, nome_conhecido, sexo, data_nascimento, data_falecimento, pais_nascimento, estado_nascimento, cidade_nascimento, biografia, url_site_oficial, url_facebook, url_twitter, url_wikipedia) VALUES (12,'Zélia','Gattai Amado de Faria','Zélia Gattai','F','1916-07-02','2008-05-17','Brasil','São Paulo','São Paulo',NULL,NULL,NULL,NULL,NULL);
INSERT INTO autor (id, nome, sobrenome, nome_conhecido, sexo, data_nascimento, data_falecimento, pais_nascimento, estado_nascimento, cidade_nascimento, biografia, url_site_oficial, url_facebook, url_twitter, url_wikipedia) VALUES (13,'Truman','Streckfus Persons','Truman Capote','M',NULL,NULL,'Estados Unidos',NULL,'Nova Orleans',NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO editora (id, nome, url_site_oficial, url_facebook, url_twitter, url_wikipedia) VALUES (8,'Grupo Companhia das Letras','','','','');
INSERT INTO editora (id, nome, url_site_oficial, url_facebook, url_twitter, url_wikipedia) VALUES (9,'Grupo Penguin','','','','');
INSERT INTO editora (id, nome, url_site_oficial, url_facebook, url_twitter, url_wikipedia) VALUES (10,'Penguin Companhia',NULL,NULL,NULL,NULL);
INSERT INTO editora (id, nome, url_site_oficial, url_facebook, url_twitter, url_wikipedia) VALUES (11,'Biblioteca Azul',NULL,NULL,NULL,NULL);
